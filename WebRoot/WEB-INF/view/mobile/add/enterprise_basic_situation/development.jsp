...
<html>
	...
	<body>
		...
		<!-- 项目促建联系人 -->
		<form action="<%=basePath%>developmentmobile/addProductPeoperFromDev.jhtml" method="post" id="productpeople">
			<div class="jsqk-con">
				<div class="intbox">
		...
		<!-- 政务办理情况 -->
		<form action="<%=basePath%>/developmentmobile/addGovernmentSituationFromDev.jhtml" method="post" id="zhengwu">
			<div class="jsqk-con">
		...
		<!-- 国土办理情况 -->
		<form action="<%=basePath%>/developmentmobile/addLandSituationFromDev.jhtml" method="post" id="guotu">
			<div class="jsqk-con">
		...
		<!-- 要素保障 -->
		<form action="<%=basePath%>/developmentmobile/addElementsOfSecurityFromDev.jhtml" method="post" id="yaosu">
		    <div class="jsqk-con">
				<div class="intbox">
		 ...
		 <!-- 建设进度 -->
		 <form action="<%=basePath%>/developmentmobile/addProjectBuildToProgressFromDev.jhtml" method="post" id="jianshejindu">
		    <div class="jsqk-con">
		...
		<script src="<%=basePath %>mobile/js/jquery1.9.0.min.js" type="text/javascript" charset="utf-8"></script>
