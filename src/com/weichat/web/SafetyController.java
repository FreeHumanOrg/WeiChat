...
public class SafetyController {
	...
	public void updateAnquanshengchan(HttpServletResponse response,@ModelAttribute Anquanshengchan anquanshengchan)throws IOException{
		LOGGER.info("企业安全生产修改!"+DateTimeUtils.getNowDateOfStringFormatUsingDateTimeTemplateOne());
		StringBuffer sbResult = new StringBuffer();
		//判断企业安全是否存在
		if(safetyService.checkAnquanshengchan(anquanshengchan.getInfomation().getId())){//存在
