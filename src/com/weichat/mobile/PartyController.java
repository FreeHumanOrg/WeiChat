 ...
 * @version 1.0 Beta
 */
@Controller("partyControllerMobile")
@RequestMapping(value = "/partymobile")
public class PartyController {
	...
	public String partyShow(HttpServletRequest request, ModelMap modelMap) {
		...
		return "/mobile/update/enterprise_update_situation/party";
	}
	...
	public void updateAnquanshengchan(HttpServletRequest request,
		...
		if (partyService.checkDangtuanjianshe(dangtuanjianshe.getInfomation().getId())) {// 存在
			...
			if (partyService.addDangtuanjiansheService(dangtuanjianshe,dangtuanjianshe.getInfomation().getId())) {
